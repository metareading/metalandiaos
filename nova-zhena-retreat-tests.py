...
class Т9_КартаНаСвета(Основа):
    ...
    МЕДАЛЬОНИ = {1: 'card/nz-sfera-01-хипократ.webp', 2: 'card/nz-sfera-02-бетовен.webp', 3: 'card/nz-sfera-03-кюри.webp', 4: 'card/nz-sfera-04-жана-дарк.webp', 5: 'card/nz-sfera-05-орфей.webp',
                 6: 'card/nz-sfera-06-деметра.webp', 7: 'card/nz-sfera-07-ботев.webp', 8: 'card/nz-sfera-08-лоренцо.webp', 9: 'card/ЕТАЛОН-леонардо-призвание-светлина.webp',
                 10: 'card/ЕТАЛОН-моцарт-творчество-злато.webp', 11: 'card/nz-sfera-11a-питагор.webp', 12: 'card/nz-sfera-12-лао-дзъ.webp'}
    ...
    def test_94_медальон_мап_будечители_по_колелото_пазач_протагонист(self):
        ...
        self.assertIn("{име:'Питагор',img:'img/nz-sferi/card/nz-sfera-11a-питагор.webp'},{име:'Фибоначи',img:'img/nz-sferi/card/nz-sfera-11b-фибоначи.webp'}", t, 'Мъдрост = 2 образа')
