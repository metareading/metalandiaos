...
echo "== preview: seam $(grep -c 'nova-zhena-seam.js v0.1.1' nova-zhena-tests/_seam-preview.html) · shell махнат $(grep -c 'form shell премахнат' nova-zhena-tests/_seam-preview.html) · стар shell $(grep -c 'V2 shell · SEAM v2 Yespo' nova-zhena-tests/_seam-preview.html) =="
